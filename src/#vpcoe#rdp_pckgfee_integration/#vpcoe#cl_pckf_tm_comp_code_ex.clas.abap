class /VPCOE/CL_PCKF_TM_COMP_CODE_EX definition
  public
  create public .
...
public section.
  ...
  types:
    BEGIN OF ltys_pckf_api_comp_code,
      ...
      END OF ltys_pckf_api_comp_code .
  types:
    ltyt_pckf_api_comp_code TYPE STANDARD TABLE OF ltys_pckf_api_comp_code WITH NON-UNIQUE KEY company_code .
  types:
    BEGIN OF ltys_pckg_fee_comp_code,
        value TYPE ltyt_pckf_api_comp_code,
      END OF ltys_pckg_fee_comp_code .
  PROTECTED SECTION.
  PRIVATE SECTION.
...
CLASS /VPCOE/CL_PCKF_TM_COMP_CODE_EX IMPLEMENTATION.
...
*deserialize json string json into abap structure
  ...
  METHOD /vpcoe/if_pckf_transfer_mapper~parse_payload.
    ...
    DATA: ls_pckg_fee_api_payload TYPE ltys_pckg_fee_comp_code,
          lo_comp_code            TYPE REF TO /vpcoe/cl_pckf_ent_comp_code,
          lt_comp_code            TYPE /vpcoe/t_comp_code_data.
    ...
    IF iv_payload IS NOT INITIAL.
      ...
      LOOP AT ls_pckg_fee_api_payload-value ASSIGNING FIELD-SYMBOL(<ls_pckg_fee_api_comp_code>).

        lo_comp_code = NEW /vpcoe/cl_pckf_ent_comp_code( is_data = VALUE #( company_code      = <ls_pckg_fee_api_comp_code>-company_code
                                                                            exemption_percent = <ls_pckg_fee_api_comp_code>-exemption_percent
                                                                            report_category   = <ls_pckg_fee_api_comp_code>-report_category
                                                                            report_fraction   = <ls_pckg_fee_api_comp_code>-report_fraction
                                                                            valid_from        = <ls_pckg_fee_api_comp_code>-valid_from
                                                                            valid_to          = <ls_pckg_fee_api_comp_code>-valid_to ) ).
        APPEND lo_comp_code TO et_entity_data.
  ...
  METHOD /VPCOE/IF_PCKF_TRANSFER_MAPPER~PREPARE_PAYLOAD.
    ...
    DATA: lr_entity       TYPE REF TO /vpcoe/cl_pckf_ent_comp_code.

    DATA: ls_entity_data_api      TYPE /vpcoe/s_pckf_comp_code,
          ls_pckg_fee_api         TYPE /vpcoe/s_pckf_comp_code,
          ls_pckg_fee_api_payload TYPE ltys_pckg_fee_comp_code.
    ...
    LOOP AT it_entity_data INTO DATA(lr_entity_data).
      ...
      ls_pckg_fee_api = VALUE #( company_code = ls_pckg_fee_entity-company_code
