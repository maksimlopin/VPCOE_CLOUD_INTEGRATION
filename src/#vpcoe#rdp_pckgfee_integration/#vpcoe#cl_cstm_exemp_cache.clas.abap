class /VPCOE/CL_CSTM_EXEMP_CACHE definition
  public
  create public .
...
CLASS /VPCOE/CL_CSTM_EXEMP_CACHE IMPLEMENTATION.
  ...
  METHOD /vpcoe/if_pckf_cache~get_entities.
    ...
    DATA: lt_rep_config_id TYPE RANGE OF /vpcoe/pckf_report_config_id,
          ...
          lt_cache_entries TYPE STANDARD TABLE OF /vpcoe/cstm_ench, "/vpcoe/pckf_ench
    ...
    SELECT uuid, entity_type, reportconfigid, jsondata, failed, creationdatetime, lastchangedatetime FROM /vpcoe/cstm_ench
    ...
    LOOP AT lt_cache_entries REFERENCE INTO DATA(lr_cache_entry).
      ...
      CASE lr_cache_entry->entity_type.
        ...
        WHEN /vpcoe/if_pckf_entity_data=>gc_entities-gc_ent_cstm_exemp.
          NEW /vpcoe/cl_pckf_tm_custom_exemp( )->/vpcoe/if_pckf_transfer_mapper~parse_payload(
            EXPORTING
              iv_payload     = lv_json_str
            IMPORTING
              et_entity_data = lt_entities
          ).
