class /VPCOE/CL_PCKF_TM_PCKG_FEE_V2 definition
  public
  create public .
...
public section.
  ...
  types:
    ltyt_pckf_api_pckg_fee_float TYPE STANDARD TABLE OF ltys_pckf_api_pckg_fee_float WITH NON-UNIQUE KEY product .
  types:
...
CLASS /VPCOE/CL_PCKF_TM_PCKG_FEE_V2 IMPLEMENTATION.
...
*deserialize json string json into abap structure
    ...
    IF lv_payload IS NOT INITIAL.
      ...
      LOOP AT ls_pckg_fee_api_payload-value INTO DATA(ls_pckg_fee_api).
        ...
        ls_pckg_fee_entity-product                        = ls_pckg_fee_api-product.
        ...
        ls_pckg_fee_entity-reportcategorycountry          = ls_pckg_fee_api-report_category_country .
        ls_pckg_fee_entity-reportcategoryregion           = ls_pckg_fee_api-report_category_region .
        ls_pckg_fee_entity-packagingcomposition           = ls_pckg_fee_api-packaging_composition .
        ls_pckg_fee_entity-referencequantity              = ls_pckg_fee_api-reference_quantity.
        ls_pckg_fee_entity-baseunitofmeasure              = ls_pckg_fee_api-base_unit_of_measure.
        ls_pckg_fee_entity-totalfee                       = ls_pckg_fee_api-total_fee.
        ls_pckg_fee_entity-currency                       = ls_pckg_fee_api-currency.
        ...
        LOOP AT ls_pckg_fee_api-suppliers INTO DATA(ls_pckg_fee_api_suppliers).
          ...
          ls_pckg_fee_ent_suppliers-supplier = ls_pckg_fee_api_suppliers-supplier.
        ...
        LOOP AT ls_pckg_fee_api-applicable_organization_data INTO DATA(ls_pckg_fee_api_org_data).
          ...
          ls_pckg_fee_ent_orgdata-companycode         = ls_pckg_fee_api_org_data-company_code.
          ls_pckg_fee_ent_orgdata-salesorganization   = ls_pckg_fee_api_org_data-sales_organization.
          ls_pckg_fee_ent_orgdata-division            = ls_pckg_fee_api_org_data-division.
          ls_pckg_fee_ent_orgdata-distributionchannel = ls_pckg_fee_api_org_data-distribution_channel.
