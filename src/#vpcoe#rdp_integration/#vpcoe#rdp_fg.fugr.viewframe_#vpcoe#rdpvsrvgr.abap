*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/VPCOE/RDPVSRVGR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/VPCOE/RDPVSRVGR    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/VPCOE/RDPVSRVGR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /VPCOE/RDPVSRVGR_EXTRACT
TOTAL = /VPCOE/RDPVSRVGR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/VPCOE/RDPVSRVGR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/VPCOE/RDPVSRVGR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/RDPVSRVGR_EXTRACT
TOTAL = /VPCOE/RDPVSRVGR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/VPCOE/RDPVSRVGR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/VPCOE/RDPVSRVGR'
...
TOTAL = /VPCOE/RDPVSRVGR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/VPCOE/RDPVSRVGR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/VPCOE/RDPVSRVGR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/VPCOE/RDPVSRVGR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/VPCOE/RDPVSRVGR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/RDPVSRVGR_EXTRACT
TOTAL = /VPCOE/RDPVSRVGR_TOTAL
