*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/VPCOE/V_TAXNUMT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/VPCOE/V_TAXNUMT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/VPCOE/V_TAXNUMT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /VPCOE/V_TAXNUMT_EXTRACT
TOTAL = /VPCOE/V_TAXNUMT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/VPCOE/V_TAXNUMT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/VPCOE/V_TAXNUMT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/V_TAXNUMT_EXTRACT
TOTAL = /VPCOE/V_TAXNUMT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/VPCOE/V_TAXNUMT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/VPCOE/V_TAXNUMT'
...
TOTAL = /VPCOE/V_TAXNUMT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/VPCOE/V_TAXNUMT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/VPCOE/V_TAXNUMT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/VPCOE/V_TAXNUMT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/VPCOE/V_TAXNUMT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/V_TAXNUMT_EXTRACT
TOTAL = /VPCOE/V_TAXNUMT_TOTAL
