*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/VPCOE/V_CONFIG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/VPCOE/V_CONFIG     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/VPCOE/V_CONFIG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /VPCOE/V_CONFIG_EXTRACT
TOTAL = /VPCOE/V_CONFIG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/VPCOE/V_CONFIG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/VPCOE/V_CONFIG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/V_CONFIG_EXTRACT
TOTAL = /VPCOE/V_CONFIG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/VPCOE/V_CONFIG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/VPCOE/V_CONFIG'
...
TOTAL = /VPCOE/V_CONFIG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/VPCOE/V_CONFIG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/VPCOE/V_CONFIG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/VPCOE/V_CONFIG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/VPCOE/V_CONFIG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/V_CONFIG_EXTRACT
TOTAL = /VPCOE/V_CONFIG_TOTAL
