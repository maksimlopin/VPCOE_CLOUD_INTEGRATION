*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/VPCOE/V_RCPNT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/VPCOE/V_RCPNT      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/VPCOE/V_RCPNT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /VPCOE/V_RCPNT_EXTRACT
TOTAL = /VPCOE/V_RCPNT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/VPCOE/V_RCPNT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/VPCOE/V_RCPNT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/V_RCPNT_EXTRACT
TOTAL = /VPCOE/V_RCPNT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/VPCOE/V_RCPNT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/VPCOE/V_RCPNT'
...
TOTAL = /VPCOE/V_RCPNT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/VPCOE/V_RCPNT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/VPCOE/V_RCPNT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/VPCOE/V_RCPNT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/VPCOE/V_RCPNT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/V_RCPNT_EXTRACT
TOTAL = /VPCOE/V_RCPNT_TOTAL
