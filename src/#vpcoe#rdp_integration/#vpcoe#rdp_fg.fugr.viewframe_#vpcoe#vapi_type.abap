*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/VPCOE/VAPI_TYPE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/VPCOE/VAPI_TYPE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/VPCOE/VAPI_TYPE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /VPCOE/VAPI_TYPE_EXTRACT
TOTAL = /VPCOE/VAPI_TYPE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/VPCOE/VAPI_TYPE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/VPCOE/VAPI_TYPE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/VAPI_TYPE_EXTRACT
TOTAL = /VPCOE/VAPI_TYPE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/VPCOE/VAPI_TYPE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/VPCOE/VAPI_TYPE'
...
TOTAL = /VPCOE/VAPI_TYPE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/VPCOE/VAPI_TYPE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/VPCOE/VAPI_TYPE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/VPCOE/VAPI_TYPE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/VPCOE/VAPI_TYPE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /VPCOE/VAPI_TYPE_EXTRACT
TOTAL = /VPCOE/VAPI_TYPE_TOTAL
