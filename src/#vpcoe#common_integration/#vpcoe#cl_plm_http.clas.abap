class /VPCOE/CL_PLM_HTTP definition
  public
...
public section.
  ...
  data MV_HTTP_VERSION type RFCDISPLAY-RFCTYPE .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !IO_LOGGER type ref to /VPCOE/IF_UPH_LOGGER optional
    raising
      CX_OA2C .
  PROTECTED SECTION.
private section.
...
CLASS /VPCOE/CL_PLM_HTTP IMPLEMENTATION.
...
METHOD constructor.
  ...
  me->mv_http_version = lv_http_version.
