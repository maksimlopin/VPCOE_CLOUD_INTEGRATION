class /VPCOE/CL_UPH_TM_PCKG_ELEM_V1 definition
  public
...
CLASS /VPCOE/CL_UPH_TM_PCKG_ELEM_V1 IMPLEMENTATION.
...
*    rv_entity_url_suffix = mc_pckg_element.
  ...
  METHOD /vpcoe/if_uph_transfer_mapper~prepare_payload.
    ...
    LOOP AT it_entity_data INTO DATA(lr_entity_data) ##CLASS_FINAL.
      ...
      ls_entity_pack_elem_api-dimension_length          = ls_pckg_data-dimensionlength."convert_dec_to_char( ls_pckg_data-dimensionlength ).
      ls_entity_pack_elem_api-dimension_width           = ls_pckg_data-dimensionwidth."convert_dec_to_char( ls_pckg_data-dimensionwidth ).
      ls_entity_pack_elem_api-dimension_height          = ls_pckg_data-dimensionheight."convert_dec_to_char( ls_pckg_data-dimensionheight ).
      ls_entity_pack_elem_api-volume                    = ls_pckg_data-volume."convert_dec_to_char( ls_pckg_data-volume ).
      ls_entity_pack_elem_api-volume_unit_of_measure    = ls_pckg_data-volumeunitofmeasure .
      ls_entity_pack_elem_api-reuse_count               = ls_pckg_data-reusecount."convert_dec_to_char( ls_pckg_data-reusecount ).
      ls_entity_pack_elem_api-recyclable_percent        = ls_pckg_data-recyclablepercent."convert_dec_to_char( ls_pckg_data-recyclablepercent ).
      ls_entity_pack_elem_api-compostable_percent       = ls_pckg_data-compostablepercent."convert_dec_to_char( ls_pckg_data-compostablepercent ).
      ...
      ls_entity_pack_elem_api-renewable_percent         = ls_pckg_data-renewablepercent."convert_dec_to_char( ls_pckg_data-renewablepercent ).
      ...
      LOOP AT lt_pckg_fractions INTO DATA(lr_pckg_fractions) ##CLASS_FINAL.
        ...
        ls_entity_pack_frac_api-weight                    = ls_pckg_fraction_data-weight."convert_dec_to_char( ls_pckg_fraction_data-weight ).
        ...
        ls_entity_pack_frac_api-recycled_content_percent  = ls_pckg_fraction_data-recycledcontentpercent."convert_dec_to_char( ls_pckg_fraction_data-recycledcontentpercent ).
        ls_entity_pack_frac_api-thickness                 = ls_pckg_fraction_data-thickness."convert_dec_to_char( ls_pckg_fraction_data-thickness ).
        ls_entity_pack_frac_api-thickness_unit_of_measure = ls_pckg_fraction_data-thicknessunitofmeasure.
        ls_entity_pack_frac_api-density                   = ls_pckg_fraction_data-density."convert_dec_to_char( ls_pckg_fraction_data-density ).
        ...
        ls_entity_pack_frac_api-renewable_percent         = ls_pckg_fraction_data-renewablepercent."convert_dec_to_char( ls_pckg_fraction_data-renewablepercent ).
