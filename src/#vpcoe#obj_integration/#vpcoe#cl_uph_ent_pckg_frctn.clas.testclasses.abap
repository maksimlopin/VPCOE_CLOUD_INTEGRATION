CLASS /vpcoe/tcl_uph_ent_pckg_frac DEFINITION FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS.

  PRIVATE SECTION.
    DATA:
      f_cut TYPE REF TO /vpcoe/cl_uph_ent_pckg_frctn.  "class under test
...
CLASS /vpcoe/tcl_uph_ent_pckg_frac IMPLEMENTATION.
  ...
  METHOD setup.
    ...
    lv_deleted = 'X'.
    f_cut =  NEW /vpcoe/cl_uph_ent_pckg_frctn( is_data = ls_data
