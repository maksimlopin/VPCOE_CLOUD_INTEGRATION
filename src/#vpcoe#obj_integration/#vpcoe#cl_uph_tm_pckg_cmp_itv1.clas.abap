CLASS /vpcoe/cl_uph_tm_pckg_cmp_itv1 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    METHODS /vpcoe/if_uph_transfer_mapper~get_entity_url_suffix       REDEFINITION.
    METHODS /vpcoe/if_uph_transfer_mapper~prepare_payload             REDEFINITION.
...
CLASS /VPCOE/CL_UPH_TM_PCKG_CMP_ITV1 IMPLEMENTATION.
