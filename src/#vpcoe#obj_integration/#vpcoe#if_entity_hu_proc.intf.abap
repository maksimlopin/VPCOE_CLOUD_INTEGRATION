INTERFACE /vpcoe/if_entity_hu_proc
  PUBLIC .

  TYPES:
    BEGIN OF gty_s_hu_for_product,
      product       TYPE matnr,
  ...
  TYPES:
    BEGIN OF gty_s_api_rp_packcomp_for_prod,
  ...
  METHODS map_hu_data DEFAULT IGNORE
    IMPORTING
      !it_packcomp_data     TYPE gty_t_api_rp_packcomp_for_prod
