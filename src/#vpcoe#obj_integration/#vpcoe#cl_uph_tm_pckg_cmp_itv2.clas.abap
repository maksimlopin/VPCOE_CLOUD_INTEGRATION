class /VPCOE/CL_UPH_TM_PCKG_CMP_ITV2 definition
  public
...
private section.
  ...
  types:
    BEGIN OF mtys_uph_api_cmp_subitem,
  ...
  types:
    BEGIN OF mtys_uph_api_cmp_item,
             packaging_element_id      TYPE c LENGTH 50,
             packaging_element_version TYPE c LENGTH 40,
  ...
  types:
    BEGIN OF mtys_uph_api_reg_pack_cmp_item,
             source   TYPE c LENGTH 64,
             elements TYPE mtyt_uph_api_pack_comp,
           END OF mtys_uph_api_reg_pack_cmp_item .

  constants MC_ENTITY_URL_SUFFIX type STRING value '/PackagingCompositionItems' ##NO_TEXT.
  data MS_ENTITY_HU_DATA_API type MTYS_UPH_API_REG_PACK_CMP_ITEM .
ENDCLASS.



CLASS /VPCOE/CL_UPH_TM_PCKG_CMP_ITV2 IMPLEMENTATION.
